...
> **Claude Code users:** Install the [Odoo Semantic plugin](dist/odoo-semantic-plugin/) for persona-specific slash commands. After install, run `/odoo-semantic:setup` — required on Claude Code v2.1.x because userConfig auto-prompt is broken upstream ([#39455](https://github.com/anthropics/claude-code/issues/39455)).
