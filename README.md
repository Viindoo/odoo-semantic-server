...
> **Claude Code users:** Install the Odoo Semantic plugin via [`/install/`](https://odoo-semantic.viindoo.com:9999/install/) (or `/plugin install odoo-semantic@viindoo-plugins` inside Claude Code) for persona-specific slash commands. After install, run `/odoo-semantic:setup` — required on Claude Code v2.1.x because userConfig auto-prompt is broken upstream ([#39455](https://github.com/anthropics/claude-code/issues/39455)).
