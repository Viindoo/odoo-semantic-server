...
# chromium binary. Re-marked browser → astro so these HTTP-header assertions run
# in the lighter astro tier (no Playwright session, exempt from the chromium-skip
# hook in tests/conftest.py::pytest_collection_modifyitems).
