...
# ---------------------------------------------------------------------------
# Pure unit tests (in-memory cache primitives + _tenant_id_var ContextVar)
# moved to tests/test_tenant_id_plumbing_unit.py (WS-D / DD2 demote — no DB,
# no RLS/GUC; G08 plumbing-only). The DB-backed verify/middleware tests below
# stay on the postgres tier.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# ContextVar wiring (_set_server_tenant_id / _reset_server_tenant_id) — pure
# ContextVar set/reset tests moved to tests/test_tenant_id_plumbing_unit.py
# (WS-D / DD2 demote — no DB).
# ---------------------------------------------------------------------------
