...
class TestAdminCascadeSetUserPlan:
    ...
    async def test_cascade_non_admin_403(self, migrated_pg):
        """Cascade plan dependency raises 403 for an authenticated non-admin.
        ...
        require_admin gate before the MFA check. Route wiring is covered by
        test_cascade_set_user_plan_route_is_wired_to_fresh_mfa.
        """
