...
# src/web_ui/_json.py
"""JSON-safe conversion for routes returning rows with datetime/Decimal/UUID/bytes.
...
Also covers: date, Decimal, UUID, bytes, nested dicts, lists, tuples.
"""
...
def _json_safe(value: Any) -> Any:
    ...
    - bytes     → hex string (lossless for audit/checksum payloads)
