...
--                           + SELECT webui_users (owner_is_admin lookup —
--                             verify_api_key_full LEFT JOIN, f9ccc23)
...
GRANT SELECT ON TABLE webui_users TO osm_reader; -- API-key auth owner_is_admin lookup (verify_api_key_full LEFT JOIN webui_users — f9ccc23)
